    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-white via-blue-50/30 to-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          {/* قسم دليل النشر الجديد */}
          <div className="mb-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-1 lg:order-1">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700]/20 to-[#001f3f]/20 rounded-3xl transform -rotate-3 group-hover:-rotate-6 transition-transform duration-300"></div>
                  <div className="relative bg-gradient-to-br from-[#FFD700] to-[#f4c430] rounded-3xl p-8 text-[#001f3f] shadow-2xl">
                    <div className="text-center">
                      <FileText className="w-16 h-16 text-[#001f3f] mx-auto mb-4" />
                      <h4 className="text-xl font-bold mb-2">دليل شامل</h4>
                      <p className="text-[#001f3f]/80">معايير النشر العلمي</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="order-2 lg:order-2">
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border-r-4 border-[#FFD700] hover:shadow-2xl transition-all duration-500 group">
                  <div className="flex items-center mb-6">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#FFD700] to-[#f4c430] rounded-xl flex items-center justify-center ml-4 group-hover:scale-110 transition-transform duration-300">
                      <FileText className="w-7 h-7 text-[#001f3f]" />
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-[#001f3f] group-hover:text-[#FFD700] transition-colors duration-300">
                      دليل النشر
                    </h3>
                  </div>
                  <p className="text-gray-700 text-lg leading-relaxed group-hover:text-gray-900 transition-colors duration-300 mb-6">
                    دليل شامل للباحثين الأكاديمي حول معايير النشر العلمي الرصين، وفقًا لسياسات واضحة تضمن الأصالة، المصداقية، والالتزام بالمعايير الأكاديمية العالمية.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed group-hover:text-gray-900 transition-colors duration-300 mb-8">
                  ...
                  <div className="space-y-4 mb-8">
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-gradient-to-br from-[#FFD700] to-[#f4c430] rounded-full flex items-center justify-center ml-3 flex-shrink-0">
                        <CheckCircle className="w-5 h-5 text-[#001f3f]" />
                      </div>
                      <p className="text-gray-700 font-medium">مراجعة الأبحاث عبر خبراء متخصصين</p>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-700 font-medium">اعتماد التوثيق وفق أنماط مرجعية معترف بها</p>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-700 font-medium">ضمان الالتزام بأخلاقيات البحث العلمي</p>
                    </div>
                  </div>
                  ...
                  <Button
                    asChild
                    size="lg"
                    className="bg-gradient-to-r from-[#001f3f] to-[#002a5c] hover:from-[#002a5c] hover:to-[#001f3f] text-white px-8 py-3 text-lg rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group/btn border-2 border-transparent hover:border-[#FFD700] w-full sm:w-auto"
                  >
                    <Link href="/submission-guidelines" className="flex items-center justify-center gap-3">
